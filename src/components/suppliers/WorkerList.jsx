...
class WorkList extends Component {
  ...
  render() {
    const columns = [{
      ...
      render: (text, record, index) => (<Link to={"/supplier/workerdetail/" + record.id} >{record.id}</Link>),   
    }, {
      title: '名称',
      dataIndex: 'name',
      key: 'name',
      ...
      key: 'mainDocumentID', 
      render: (text, record, index) => (<Link to={"/supplier/orderdetail/" + record.mainDocumentID} >{record.mainDocumentID}</Link>),  
    }, {
      title: 'CV',
      dataIndex: 'cv',
      key: 'cv', 
